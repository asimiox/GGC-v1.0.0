...
BEGIN
    ...
    -- Strict verification against database admin_profiles
...
-- ==============================================================================
-- 9. USER SESSIONS & DATABASE AUTH RPCs
-- ==============================================================================
...
CREATE POLICY "Public read-write for user_sessions" ON public.user_sessions FOR ALL USING (true) WITH CHECK (true);
